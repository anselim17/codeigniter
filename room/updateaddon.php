    ...
    <div style="background-color: rgb(44, 115, 231);" id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../pages/index.php"><span class="fa fa-cogs "></span> Westview Pension House - <?php echo ucfirst($user);?></a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Addon</h1>
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                       ...
                       <div class="form-group">
                                    ...
                                    <?php 
                                    include("../../connection.php");
                                    $addonid = mysqli_real_escape_string($conn, $_GET['addonid']);
                                    $sql = "select tblreservation.Confirmation,tbltransaction.Reservation_ID from tbladdonreserve 
                                     Inner JOIN tblreservation on tbladdonreserve.Reservation_ID=tblreservation.Reservation_ID
                                     Inner JOIN tbltransaction on tbladdonreserve.Reservation_ID=tbltransaction.Reservation_ID  where tbladdonreserve.addonid = '$addonid'";
                                     $_SESSION['addonid']=$addonid;

                                    $result = mysqli_query($conn,$sql) or die(mysqli_error($conn));
                                    while ($row = mysqli_fetch_assoc($result)) {
                                      $rid=$row['Reservation_ID'];
                                      $_SESSION['Reservation_ID']=$rid;
                                    echo "<input  id='user' name='user' value='".$type."' onkeypress='return isNumberKey(event)' type='hidden'>";                                  
                                    ...
                                    echo '<select id="editaddon" class="form-control" name="item" required>';
                                ...
                                <div class="form-group">
                                <a href="../pages/transaction.php" type="button" class="btn btn-default"  data-dismiss="modal">Cancel</a>
                                <button type="button" name="addingon" onclick="updateAddon()" class="btn btn-primary">Update</button>
                                </div>
