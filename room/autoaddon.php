                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                       ...
                       <div class="form-group">
                                    ...
                                    echo "<input name='customerid' id='customerid' value='".$row['Customer_ID']."' onkeypress='return isNumberKey(event)' type='hidden' required>";
                                    echo "<input name='status' id='stat' value='".$row['Status']."'  type='hidden' required>";                                    
                                    ...
                                    <input class="form-control" type="text" id="price" name="price" readonly placeholder="Price">
                                    <input class="form-control" type="text" name="amount" id="amount" readonly placeholder="Amount" >   
                                </div>
                                ...
                                <button type="button" name="addingon" onclick="validAddingOn()" class="btn btn-primary">Save</button>
                                </div>
