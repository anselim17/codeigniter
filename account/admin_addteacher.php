...
$sql="insert into user (section_id,username,password,secretquestion,secretanswer,role,Status) values ('$sectionid','$username','$pword','$secretquestion','','$role','$status')";
$result=mysqli_query($conn,$sql);
if ($result==true)
{
...
</br>	<label for="home">Secret Question: </label>
<select name="secretquestion" style="width:150px;" required>
								 <p>
								<option value="what is your favorite place" >what is your favorite place</option>
								<option value="what is the name of your pet" >what is the name of your pet</option>
								<option value="what is your favorite food" >what is your favorite food</option>
								<option value="what is your mother's maiden" >what is your mother's maiden</option>
